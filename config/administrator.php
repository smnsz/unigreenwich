...
return array(
     ...
     */
    /* 	'menu' => array(
      'Users Management' => array('user','friends','usercomments'),
      'Post Management' => array('tags','posts','poststags','comments'),
      'Events' => array('events','eventtypes','eventcomments'),
      'Forum'=> array('forumcategories','forumposts','forumthreads'),
      'Private Messages'=> array('messages','threads','participants'),
      'bookings',
      'categories'
      //'Forums Management' => array('collections', 'products', 'product_images', 'orders'),
      ), */
    
    'menu' => array(
        'Users management' => array('user', 'friends', 'usercomments'),
        //'Post Management' => array('tags', 'posts', 'poststags', 'comments'),
        'Post Management' => array('tags', 'posts', 'comments'),
        'Events' => array('events', 'eventtypes', 'eventcomments'),
        'Forum' => array('forumcategories', 'forumposts', 'forumthreads'),
        //'Private Messages'=> array('messages','threads','participants'),
        //'bookings',
