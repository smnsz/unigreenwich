				{!! Form::open(array('route' => $route,'method' => 'post','role' => 'form','class' => 'form-horizontal','id' => 'form')) !!}
					...
					<div class="form-actions">
			            ...
			            @if (null !== request('id'))
			            	<a class="btn btn-default" href="{{ route('getPostDelete',request('id')) }}">Delete</a>
			            @endif
			        </div>
					    ...
					    <div class="modal-content">
					        ...
					        <div class="modal-body image-upload-modal-body" >
					        	...
					        	<div class="panel-body">
 					        		...
 					        		<button type="button" class="btn btn btn-primary pull-right" id="imageLocalButton" >Upload</button>
					        ...
					        <div class="modal-footer image-upload-modal-footer">
					        	<button type="button" id="addToPostButton" class="btn btn btn-primary " data-dismiss="modal">Add to Post</button>
					        </div>
					    </div>
