				...
				<div class="panel-body">
					<div class="list-group post-list-group">
						@can('update-post', $post)	
							<a class="btn btn-primary pull-right reload-button" href="{{ route('getPostUpdate',$post->id) }}">Edit post</a>
						@endcan
				        	...
				        	<div class="comment-list-container">
				        		@if($post->has('comments'))
				        			...
				        			<div class="comment-list">
				        				<div>
				        					<a href="{{ route('profile_path',$comment->user->username) }}"> {{ $comment->user->first_name }} {{ $comment->user->last_name }} </a>
				        				</div>
				        				<div>
				        					{!! $comment->comment !!}
				        				</div>
